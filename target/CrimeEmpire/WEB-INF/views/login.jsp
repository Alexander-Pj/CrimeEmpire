  ...
  <body>
   <div class="main_container" id="workspace">
        ...
        <div class='geos_welcome_container draggable'>
          ...
          <div class="text_area">
            <span>Welcome to CrimeEmpire<p>PLEASE Log in or Create User</p><br><p>
            ${info}
			<form method="post" action="/CrimeEmpire/login">
			Login: <input type="text" name="login" placeholder="login"><br>
			Password: 	<input type="password" name="password" placeholder="password"><br><br>
			<button class="button1 geos_welcome_container_button"><input type="submit" value="Log In"/></button>
			</form>
			<form action="/CrimeEmpire/addUser" class="button1 geos_welcome_container_button">
