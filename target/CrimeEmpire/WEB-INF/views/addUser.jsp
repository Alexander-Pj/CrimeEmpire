  ...
  <body>
    <div class="main_container" id="workspace">
        ...
        <div class='geos_addUser_container draggable'>
          ...
          <div class="text_area">
            <span>Enter User Name & password<p><form:form method="post" modelAttribute="user"><br>
			Login: <form:input path="userName" placeholder="login"/><br>
			<form:errors path="userName"/>
			Password: <form:password path="password" placeholder="password"/><br>
			<form:errors path="password"/>
			email: <form:input path="email" placeholder="email"/><br>
			<form:errors path="email"/>
			I want to recive emails<form:checkbox path="agreed"/><br>
			<p><br>
			<button class="button1 geos_welcome_container_button"><input type="submit" value="Add User"/></button></p>
			</form:form>
			</p></span>
          </div>
        </div>
